...
public final class D2IInstrumenter implements OpCodeInstrumenter {
    @Override
    public void instrument(MethodVisitor mv, int opCode, String classPath, Methods methods, Reaction reaction, LocalVariablesSorter src) {
        ...
        mv.visitLdcInsn(new Double("-2.147483648E9")); // a,a, IMAX
        mv.visitInsn(DCMPL); //not DCMPG, for NaN      // a,(a>IMAX)
        Label l0 = new Label();
