...
public final class IADDInstrumenter implements OpCodeInstrumenter {
    @Override
    public void instrument(MethodVisitor methodVisitor, int opCode, String classPath, Methods methods, Reaction reaction, LocalVariablesSorter src) {
        ...
        methodVisitor.visitJumpInsn(IFGE, fin);

        reaction.insertReactionCall(methodVisitor, "Overflow : IADD", methods, classPath);
