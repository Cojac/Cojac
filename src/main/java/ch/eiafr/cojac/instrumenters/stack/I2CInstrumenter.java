...
public final class I2CInstrumenter implements OpCodeInstrumenter {
    @Override
    public void instrument(MethodVisitor methodVisitor, int opCode, String classPath, Methods methods, Reaction reaction, LocalVariablesSorter src) {
        ...
        methodVisitor.visitLdcInsn(Character.MAX_VALUE);
        methodVisitor.visitJumpInsn(IF_ICMPGT, label1);
        methodVisitor.visitJumpInsn(GOTO, fin);
        methodVisitor.visitLabel(label);
        methodVisitor.visitInsn(POP);
        methodVisitor.visitLabel(label1);
        reaction.insertReactionCall(methodVisitor, "Overflow : I2C", methods, classPath);
