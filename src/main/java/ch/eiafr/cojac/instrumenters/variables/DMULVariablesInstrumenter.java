...
public final class DMULVariablesInstrumenter implements OpCodeInstrumenter {
    @Override
    public void instrument(MethodVisitor mv, int opCode, String classPath, Methods methods, Reaction reaction, LocalVariablesSorter src) {
        ...
        reaction.insertReactionCall(mv, "Result is Double.POSITIVE_INFINITY : DMUL", methods, classPath);
        ...
        reaction.insertReactionCall(mv, "Result is Double.NEGATIVE_INFINITY : DMUL", methods, classPath);
        mv.visitLabel(l0);
        src.visitVarInsn(DLOAD, r);
    }
}
