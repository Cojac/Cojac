...
/* ------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------ */
     ...
     */
    public Random() {
        initialize((int) (System.currentTimeMillis() / 1024));
    }

    /**
     * Initializes a sequence of uniformly distributed quasi random numbers on a given half-open interval [left,right)
    ...
    /**
     * Initializes a sequence of uniformly distributed quasi random numbers with a given seed on a given half-open
     * interval [left,right).
     *
     * @param <B>seed</B>  (int)<BR>
     *                     <p/>
